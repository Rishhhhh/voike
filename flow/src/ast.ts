...
export const FLOW_OP_KEYWORDS = {
  ...
  'RUN VASM': 'RUN_VASM' as const,
  'CALL FLOW': 'CALL_FLOW' as const,
  CALL_FLOW: 'CALL_FLOW' as const,
  APX_EXEC: 'APX_EXEC' as const,
  'BUILD VPKG': 'BUILD_VPKG' as const,
  BUILD_VPKG: 'BUILD_VPKG' as const,
  'DEPLOY SERVICE': 'DEPLOY_SERVICE' as const,
  DEPLOY_SERVICE: 'DEPLOY_SERVICE' as const,
  CALL: 'CALL' as const,
  ASK_AI: 'ASK_AI' as const,
  OUTPUT_TEXT: 'OUTPUT_TEXT' as const,
  'OUTPUT TEXT': 'OUTPUT_TEXT' as const,
